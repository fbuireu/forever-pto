...
- The server does almost nothing, which is what makes a request-priced runtime the right host — [ADR 0004](./0004-cloudflare-workers-as-deployment-target.md).
