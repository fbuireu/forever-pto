  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        'size-5 rounded-none border-2 border-black dark:border-white bg-background focus-visible:ring-offset-2 data-[checked]:bg-primary data-[checked]:text-primary-foreground cursor-pointer',
        className
      )}
      {...props}
