...
import { Dialog, DialogContent } from '@ui/modules/components/core/dialog/Dialog';
...
const CommandShortcut = ({ className, ...props }: HTMLAttributes<HTMLSpanElement>) => {
	return <span className={mergeClasses("ml-auto text-xs tracking-widest text-muted-foreground", className)} {...props} />;
};
