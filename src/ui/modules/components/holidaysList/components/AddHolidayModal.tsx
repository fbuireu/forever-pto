...
import { z } from 'zod';
import { Calendar as CalendarComponent, type FromTo } from '../../core/Calendar';
...
export const AddHolidayModal = ({ open, onClose, locale }: AddHolidayModalProps) => {
  const { holidays, addHoliday } = useHolidaysStore();
      ...
      <DialogContent className='sm:max-w-lg'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-6' noValidate>
          ...
          <div className='flex gap-2 pt-2'>
            <Button type='submit' disabled={!selectedDate || !watch('name')} className='flex-1'>
