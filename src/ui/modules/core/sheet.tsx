...
function SheetHeader({ className, ...props }: ComponentProps<"div">) {
	return <div data-slot="sheet-header" className={mergeClass("flex flex-col gap-1.5 p-4", className)} {...props} />;
}

function SheetFooter({ className, ...props }: ComponentProps<"div">) {
	return (
		<div data-slot="sheet-footer" className={mergeClass("mt-auto flex flex-col gap-2 p-4", className)} {...props} />
	);
}
...
function SheetTitle({ className, ...props }: ComponentProps<typeof SheetPrimitive.Title>) {
	return (
		<SheetPrimitive.Title
			...
			className={mergeClass("text-foreground font-semibold", className)}
			{...props}
		/>
	);
}
