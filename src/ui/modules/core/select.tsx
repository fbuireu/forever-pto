...
>(({ className, ...props }, ref) => (
	<SelectPrimitive.ScrollUpButton
		ref={ref}
		className={mergeClass("flex cursor-default items-center justify-center py-1", className)}
		{...props}
	>
...
>(({ className, ...props }, ref) => (
	<SelectPrimitive.Label ref={ref} className={mergeClass("px-2 py-1.5 text-sm font-semibold", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
	<SelectPrimitive.Separator ref={ref} className={mergeClass("-mx-1 my-1 h-px bg-muted", className)} {...props} />
));
