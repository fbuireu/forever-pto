...
function SidebarGroupLabel({ className, asChild = false, ...props }: SidebarGroupLabelProps) {
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground/75 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-[8px] px-2 text-[0.68rem] font-mono font-black uppercase tracking-[0.1em] outline-hidden transition-[margin,opa] duration-200 ease-linear focus-visible:ring-[3px] [&>svg]:size-4 [&>svg]:shrink-0',
