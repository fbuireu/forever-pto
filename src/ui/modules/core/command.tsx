...
import { Dialog, DialogContent } from '@modules/core/dialog';
...
>(({ className, ...props }, ref) => (
	<CommandPrimitive.Separator ref={ref} className={mergeClass("-mx-1 h-px bg-border", className)} {...props} />
));
...
const CommandShortcut = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => {
	return <span className={mergeClass("ml-auto text-xs tracking-widest text-muted-foreground", className)} {...props} />;
};
