  ...
  return (
    ...
    >
      <SliderPrimitive.Control className='relative flex w-full touch-none items-center'>
        ...
        <SliderPrimitive.Thumb className='block h-7 w-7 rounded-full border-[3px] border-[var(--frame)] bg-accent [filter:var(--drop-shadow-brutal-xs)] transition-all duration-75 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring focus-visible:ring-offset-2 hover:-translate-x-0.5 hover:-translate-y-0.5 hover:[filter:var(--drop-shadow-brutal-sm)] disabled:pointer-events-none disabled:opacity-50' />
