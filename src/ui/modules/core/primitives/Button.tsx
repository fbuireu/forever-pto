...
const buttonVariants = cva(
  "relative cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[8px] text-sm font-black tracking-[0.01em] transition-[color,background-color,border-color,box-shadow,transform] duration-100 ease-out disabled:pointer-events-none disabled:opacity-50 disabled:cursor-default disabled:shadow-none disabled:translate-x-0 disabled:translate-y-0 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-[3px] focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background aria-invalid:ring-destructive/20 aria-invalid:border-destructive border-[3px] border-[var(--frame)] before:content-[''] before:absolute before:inset-0 before:-bottom-4 before:-right-4",
  {
    variants: {
      variant: {
        default:
        ...
        success:
          'bg-green-700 text-white shadow-[var(--shadow-brutal-btn)] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:bg-green-800 hover:shadow-[var(--shadow-brutal-btn-hover)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[var(--shadow-brutal-btn-active)] data-[popup-open]:-translate-x-0.5 data-[popup-open]:-translate-y-0.5 data-[popup-open]:shadow-[var(--shadow-brutal-btn-hover)]',
        outline:
