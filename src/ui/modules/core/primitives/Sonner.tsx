    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          closeButton:
            '!rounded-[8px] !border-[3px] !border-[var(--frame)] !bg-[var(--surface-panel)] !text-foreground !opacity-100 !size-7 [&_svg]:!size-4 ![filter:var(--drop-shadow-brutal-xs)] !transition-all !duration-75 hover:!-translate-x-0.5 hover:!-translate-y-0.5 hover:![filter:var(--drop-shadow-brutal-sm)]',
        },
      }}
      {...props}
    />
