    ...
    <section className='px-7 py-24 bg-[var(--frame)] text-[var(--background)] border-t-[4px] border-[var(--frame)] relative overflow-hidden'>
      ...
      <div className='max-w-[900px] mx-auto text-center relative z-[2]'>
        ...
        <Button
          ...
          size='lg'
          asChild
          className='[filter:var(--drop-shadow-brutal-btn-inverted)] hover:[filter:var(--drop-shadow-brutal-btn-inverted-hover)] active:[filter:var(--drop-shadow-brutal-btn-inverted-active)]'
        >
