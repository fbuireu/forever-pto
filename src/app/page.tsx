...
export default async function ForeverPto({ searchParams }: ForeverPtoProps) {
	...
	return (
		<div className="grid min-h-screen grid-rows-[auto_1fr_auto] gap-8 p-4 sm:p-8">
			<Filters country={country} region={region} year={year} ptoDays={ptoDays} allowPastDays={allowPastDays} />
			...
			<footer className="mt-8 text-center text-sm text-muted-foreground">
				...
				<p>
					Los fines de semana y festivos ya están preseleccionados. Haz clic en cualquier día laborable para añadirlo
					como día PTO.
				</p>
				<p>
