...
const HolidaysList = dynamic(() =>
  import('@ui/modules/pages/planner/HolidaysList').then((module) => module.HolidaysList)
);
const ManagementBar = dynamic(() =>
  import('@ui/modules/pages/planner/ManagementBar').then((module) => module.ManagementBar)
);
const CalendarList = dynamic(() =>
  import('@ui/modules/pages/planner/CalendarList').then((module) => module.CalendarList)
);
