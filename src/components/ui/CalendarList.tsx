        ...
        const formattedIntervals = intervalsWithTotalDays.map(
                ({ interval, ptoDays, totalFreeDays }) => {
                    ...
                    if (interval.length === 1) {
                        ...
                        // Interval of days
                        text = `${getDate(start)} al ${getDate(end)} de ${format(start, 'MMMM',
                                { locale: es })}: ${ptoDays} días.`;
                    }
                    ...
                    {monthsToShow.map((month) => {
                        return (
                                <Card key={month.toISOString()} className="mb-4 flex flex-col">
                                                            ...
                                                            <div className="relative">
                                                                <button
                                                                        ...
                                                                        data-alternative-position={alternativePosition ||
                                                                                ''}
                                                                        data-hovered-block={hoveredBlockId === blockId
                                                                                ? 'true'
                                                                                : ''}
                                                                        data-date={dateKey}
                                    ...
                                    />
                                    {ptoDays > 0 && suggestedDays.length > 0 && getSuggestedDaysForMonth(month).length >
                                            0 && (
                                                    <>
                                                                ...
                                                                <div className="text-xs mt-2 p-2 bg-primary/10 border border-primary/20 rounded-md">
                                                                    ...
                                                                    <div className="mt-2 text-xs text-muted-foreground">
                                                                        <p>
                                                                            ...
                                                                            sugerido <br /> para ver alternativas
                                                                            similares.
                                                                        </p>
                                                                    </div>
                                                                </div>
