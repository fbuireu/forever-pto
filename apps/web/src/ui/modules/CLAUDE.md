...
- `bones/registry.ts` is generated and carries a "do not edit" banner. It registers every bone under a
...
`isServiceConsented`, `consentedAnalyticsServices` and `allAnalyticsServices`. `CookieConsent.tsx` derived that
