...
describe('privacy-policy/page', () => {
  ...
  it('calls getTranslations with the privacyPolicy namespace', async () => {
    await PrivacyPolicyPage(makeParams());
  ...
  it('passes locale to getTranslations', async () => {
    await PrivacyPolicyPage(makeParams(ES));
