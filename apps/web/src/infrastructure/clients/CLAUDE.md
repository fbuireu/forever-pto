...
- `payments/stripe/serverService.ts` is the Effect service. Node SDK, API version pinned to `'2026-07-29.dahlia'`,
...
- `payments/stripe/client.ts` is browser only, `@stripe/stripe-js`. The `StripeClient` class is **not**
