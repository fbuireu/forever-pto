...
| `images/` | [`loader.ts`](./images/loader.ts): rewrites an image src to `/cdn-cgi/image/...`, the Cloudflare optimiser used in place of Next's built-in one ([ADR 0004](../../../../adr/0004-cloudflare-workers-as-deployment-target.md)) |
