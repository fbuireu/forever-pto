...
Two paths have to work: activating immediately after donating, and getting access back on a second device weeks later. The first can be verified against Stripe. The second cannot — there is nothing to verify against except the email address itself.
